...
public class CurrenciesExchangeServiceTest {
    ...
    public void testGetConversionMultiplier() throws Exception {
        ...
        assertEquals("usdToEur didn't compute right (perhaps downloaded)",
                CurrencyRatesProvider.Static.getConversionMultiplierFromIntermediateMultipliers(rubToUsd.get(), rubToEur.get()), usdToEur.get());
        ...
        assertEquals(CurrencyRatesProvider.Static.reverseRate(rubToUsd.get()), usdToRub.get());
