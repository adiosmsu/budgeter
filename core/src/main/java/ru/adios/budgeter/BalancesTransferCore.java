...
public class BalancesTransferCore implements MoneySettable, Submitter<BalancesTransferCore.AccountsPair> {
    ...
    private final SubmitHelper<AccountsPair> helper = new SubmitHelper<>(logger, "Error while performing balances transfer business logic");
    ...
    public Result<AccountsPair> submit() {
        final ResultBuilder<AccountsPair> resultBuilder = new ResultBuilder<>();
