...
public interface Submitter<T> {
    ...
    final class Result<T> {
        ...
        public static <T> Result<T> success(@Nullable T submitResult) {
            return new Submitter.Result<>(null, ImmutableList.<FieldError>of(), submitResult);
        }
    ...
    final class ResultBuilder<T> {
        ...
        private ImmutableSet.Builder<FieldError> fieldErrorsBuilder = new ImmutableSet.Builder<>();
        ...
        public Result<T> build() {
            return new Result<>(generalError, ImmutableList.copyOf(fieldErrorsBuilder.build()), submitResult);
        }
