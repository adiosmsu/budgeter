...
public class PriceAdditionElementCore implements Submitter<SubjectPrice> {
    ...
    private final SubmitHelper<SubjectPrice> helper = new SubmitHelper<>(logger, "Error while adding new subject price");
    ...
    public Result<SubjectPrice> submit() {
        final Submitter.ResultBuilder<SubjectPrice> resultBuilder = new ResultBuilder<>();
