...
public class TreasuryPseudoTableTest {
    ...
    public void testStreamRegisteredCurrencies() throws Exception {
        ...
        final List<CurrencyUnit> collected = TreasuryPseudoTable.INSTANCE.streamRegisteredCurrencies().sorted((o1, o2) -> {
    ...
    public void testStreamRegisteredAccounts() throws Exception {
        ...
        assertTrue("Name match failed [usd,usd2,eur]: " + Arrays.toString(checker), TreasuryPseudoTable.INSTANCE.streamRegisteredAccounts().allMatch(account -> {
