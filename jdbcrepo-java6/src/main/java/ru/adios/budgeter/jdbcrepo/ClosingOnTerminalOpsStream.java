...
public class ClosingOnTerminalOpsStream<T> implements Stream<T> {
    ...
    static <T> ClosingOnTerminalOpsStream<T> stream(Stream<T> stream) {
        return new ClosingOnTerminalOpsStream<T>(stream);
    }


    private static final Logger logger = LoggerFactory.getLogger(ClosingOnTerminalOpsStream.class);

    private static <T> void closeSilently(BaseStream delegate) {
        try {
            delegate.close();
    ...
    public ClosingOnTerminalOpsStream<T> distinct() {
        return new ClosingOnTerminalOpsStream<T>(delegate.distinct());
    }

    @Override
    public ClosingOnTerminalOpsStream<T> filter(Predicate<? super T> predicate) {
        return new ClosingOnTerminalOpsStream<T>(delegate.filter(predicate));
    }
    ...
    public <R> ClosingOnTerminalOpsStream<R> flatMap(Function<? super T, ? extends Stream<? extends R>> mapper) {
        return new ClosingOnTerminalOpsStream<R>(delegate.flatMap(mapper));
    }
    ...
    public ClosingOnTerminalOpsStream<T> limit(long maxSize) {
        return new ClosingOnTerminalOpsStream<T>(delegate.limit(maxSize));
    }

    @Override
    public <R> ClosingOnTerminalOpsStream<R> map(Function<? super T, ? extends R> mapper) {
        return new ClosingOnTerminalOpsStream<R>(delegate.map(mapper));
    }
    ...
    public ClosingOnTerminalOpsStream<T> peek(Consumer<? super T> action) {
        return new ClosingOnTerminalOpsStream<T>(delegate.peek(action));
    }
    ...
    public ClosingOnTerminalOpsStream<T> skip(long n) {
        return new ClosingOnTerminalOpsStream<T>(delegate.skip(n));
    }
    ...
    public ClosingOnTerminalOpsStream<T> sorted() {
        return new ClosingOnTerminalOpsStream<T>(delegate.sorted());
    }

    @Override
    public ClosingOnTerminalOpsStream<T> sorted(Comparator<? super T> comparator) {
        return new ClosingOnTerminalOpsStream<T>(delegate.sorted(comparator));
    }
    ...
    public AutoClosingIterator<T> iterator() {
        return new AutoClosingIterator<T>(delegate.iterator(), this);
    }

    @Override
    public ClosingOnTerminalOpsStream<T> onClose(Runnable closeHandler) {
        return new ClosingOnTerminalOpsStream<T>(delegate.onClose(closeHandler));
    }

    @Override
    public ClosingOnTerminalOpsStream<T> parallel() {
        return new ClosingOnTerminalOpsStream<T>(delegate.parallel());
    }

    @Override
    public ClosingOnTerminalOpsStream<T> sequential() {
        return new ClosingOnTerminalOpsStream<T>(delegate.sequential());
    }

    @Override
    public AutoClosingSpliterator<T> spliterator() {
        return new AutoClosingSpliterator<T>(delegate.spliterator(), this);
    }

    @Override
    public ClosingOnTerminalOpsStream<T> unordered() {
        return new ClosingOnTerminalOpsStream<T>(delegate.unordered());
    }
    ...
    public static final class AutoClosingSpliterator<T> implements Spliterator<T>, Closeable {
        ...
        public boolean hasCharacteristics(int characteristics) {
            try {
                return d.hasCharacteristics(characteristics);
            } catch (RuntimeException rt) {
                close();
                throw rt;
            }
        ...
        public AutoClosingSpliterator<T> trySplit() {
            ...
            return new AutoClosingSpliterator<T>(d, streamDelegate);
        }
    ...
    public static final class AutoClosingIntStream implements IntStream {
        ...
        public ClosingOnTerminalOpsStream<Integer> boxed() {
            return new ClosingOnTerminalOpsStream<Integer>(d.boxed());
        }
        ...
        public <U> ClosingOnTerminalOpsStream<U> mapToObj(IntFunction<? extends U> mapper) {
            return new ClosingOnTerminalOpsStream<U>(d.mapToObj(mapper));
        }
    ...
    public static final class AutoClosingLongStream implements LongStream {
        ...
        public ClosingOnTerminalOpsStream<Long> boxed() {
            return new ClosingOnTerminalOpsStream<Long>(d.boxed());
        }
    ...
    public static final class AutoClosingDoubleStream implements DoubleStream {
        ...
        public ClosingOnTerminalOpsStream<Double> boxed() {
            return new ClosingOnTerminalOpsStream<Double>(d.boxed());
        }
    ...
    public static final class AutoClosingIntSpliterator implements Spliterator.OfInt, Closeable {

        private final OfInt d;
    ...
    public static final class AutoClosingLongSpliterator implements Spliterator.OfLong, Closeable {

        private final OfLong d;
    ...
    public static final class AutoClosingDoubleSpliterator implements Spliterator.OfDouble, Closeable {

        private final OfDouble d;
    ...
    public static final class AutoClosingIntIterator implements PrimitiveIterator.OfInt, Closeable {
    ...
    public static final class AutoClosingLongIterator implements PrimitiveIterator.OfLong, Closeable {
