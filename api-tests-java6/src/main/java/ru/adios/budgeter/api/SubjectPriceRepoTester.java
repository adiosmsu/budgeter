...
public class SubjectPriceRepoTester {
    ...
    public void testStreamByAgent() throws Exception {
        ...
        assertEquals(
                ...
                3,
                subjectPrices.streamByAgent(food, agent, new OrderBy<SubjectPriceRepository.Field>(SubjectPriceRepository.Field.DAY, Order.ASC))
        ...
        assertEquals(
                "Wrong number of prices in stream (with order)",
                3,
                subjectPrices.streamByAgent(food.id.getAsLong(), agent.id.getAsLong(), new OrderBy<SubjectPriceRepository.Field>(SubjectPriceRepository.Field.DAY, Order.ASC))
                        .collect(Collectors.toList())
                        .size()
        );
        assertEquals(
                ...
                2,
                subjectPrices.streamByAgent(food, agent, OptLimit.createLimit(2), new OrderBy<SubjectPriceRepository.Field>(SubjectPriceRepository.Field.DAY, Order.ASC))
                        .collect(Collectors.toList())
                        .size()
        );
        assertEquals(
                "Wrong number of prices in stream (with order and limit)",
                2,
                subjectPrices.streamByAgent(food.id.getAsLong(), agent.id.getAsLong(), OptLimit.createLimit(2), new OrderBy<SubjectPriceRepository.Field>(SubjectPriceRepository.Field.DAY, Order.ASC))
                        .collect(Collectors.toList())
                        .size()
        );
        assertEquals(
        ...
        assertEquals(
                ...
                3,
                subjectPrices.streamByAgent(food.name, agent.name, new OrderBy<SubjectPriceRepository.Field>(SubjectPriceRepository.Field.DAY, Order.DESC))
                        .collect(Collectors.toList())
                        .size()
        );
        assertEquals(
                ...
                2,
                subjectPrices.streamByAgent(food.name, agent.name, new OrderBy<SubjectPriceRepository.Field>(SubjectPriceRepository.Field.DAY, Order.DESC), OptLimit.createLimit(2))
                        .collect(Collectors.toList())
                        .size()
        );
        ...
        assertEquals(
                ...
                latest,
                subjectPrices.streamByAgent(food, agent, new OrderBy<SubjectPriceRepository.Field>(SubjectPriceRepository.Field.DAY, Order.DESC), OptLimit.createLimit(1)).findFirst().get()
        );
        assertEquals(
                "Not latest price though ordered DESC (String API version)",
                latest,
                subjectPrices.streamByAgent(food.name, agent.name, new OrderBy<SubjectPriceRepository.Field>(SubjectPriceRepository.Field.DAY, Order.DESC), OptLimit.createLimit(1))
                        .findFirst().get()
        );
        assertEquals(
                "Not farthest price though ordered ASC",
                farthest,
                subjectPrices.streamByAgent(food, agent, new OrderBy<SubjectPriceRepository.Field>(SubjectPriceRepository.Field.DAY, Order.ASC), OptLimit.createLimit(1)).findFirst().get()
        );
        assertEquals(
                "Not farthest price though ordered ASC (String API version)",
                farthest,
                subjectPrices.streamByAgent(food.name, agent.name, new OrderBy<SubjectPriceRepository.Field>(SubjectPriceRepository.Field.DAY, Order.ASC), OptLimit.createLimit(1))
                        .findFirst().get()
        );
        ...
        assertEquals(
                ...
                price,
                subjectPrices.streamByAgent(food, agent, new OrderBy<SubjectPriceRepository.Field>(SubjectPriceRepository.Field.PRICE, Order.DESC), OptLimit.createLimit(1)).findFirst().get()
        );
        assertEquals(
                "Not highest price though ordered DESC (String API version)",
                price,
                subjectPrices.streamByAgent(food.name, agent.name, new OrderBy<SubjectPriceRepository.Field>(SubjectPriceRepository.Field.PRICE, Order.DESC), OptLimit.createLimit(1))
                        .findFirst().get()
        );
    }
    ...
    public void testStream() throws Exception {
        ...
        assertEquals(
                "Wrong number of prices in stream (with order)",
                5,
                subjectPrices.stream(food, new OrderBy<SubjectPriceRepository.Field>(SubjectPriceRepository.Field.DAY, Order.ASC))
                        .collect(Collectors.toList())
                        .size()
        );
        assertEquals(
                "Wrong number of prices in stream (with order)",
                5,
                subjectPrices.stream(food.id.getAsLong(), new OrderBy<SubjectPriceRepository.Field>(SubjectPriceRepository.Field.DAY, Order.ASC))
                        .collect(Collectors.toList())
                        .size()
        );
        assertEquals(
                "Wrong number of prices in stream (with order and limit)",
                4,
                subjectPrices.stream(food, OptLimit.createLimit(4), new OrderBy<SubjectPriceRepository.Field>(SubjectPriceRepository.Field.DAY, Order.ASC))
                        .collect(Collectors.toList())
                        .size()
        );
        assertEquals(
                "Wrong number of prices in stream (with order and limit)",
                4,
                subjectPrices.stream(food.id.getAsLong(), OptLimit.createLimit(4), new OrderBy<SubjectPriceRepository.Field>(SubjectPriceRepository.Field.DAY, Order.ASC))
                        .collect(Collectors.toList())
                        .size()
        );
        assertEquals(
        ...
        assertEquals(
                "Wrong number of prices in stream (String API version) (with order)",
                5,
                subjectPrices.stream(food.name, new OrderBy<SubjectPriceRepository.Field>(SubjectPriceRepository.Field.DAY, Order.DESC))
                        .collect(Collectors.toList())
                        .size()
        );
        assertEquals(
                "Wrong number of prices in stream (String API version) (with order and limit)",
                4,
                subjectPrices.stream(food.name, new OrderBy<SubjectPriceRepository.Field>(SubjectPriceRepository.Field.DAY, Order.DESC), OptLimit.createLimit(4))
                        .collect(Collectors.toList())
                        .size()
        );
        ...
        assertEquals(
                "Not latest price though ordered DESC",
                latest,
                subjectPrices.stream(food, new OrderBy<SubjectPriceRepository.Field>(SubjectPriceRepository.Field.DAY, Order.DESC), OptLimit.createLimit(1)).findFirst().get()
        );
        assertEquals(
                "Not latest price though ordered DESC (String API version)",
                latest,
                subjectPrices.stream(food.name, new OrderBy<SubjectPriceRepository.Field>(SubjectPriceRepository.Field.DAY, Order.DESC), OptLimit.createLimit(1))
                        .findFirst().get()
        );
        assertEquals(
                "Not farthest price though ordered ASC",
                farthest,
                subjectPrices.stream(food, new OrderBy<SubjectPriceRepository.Field>(SubjectPriceRepository.Field.DAY, Order.ASC), OptLimit.createLimit(1)).findFirst().get()
        );
        assertEquals(
                "Not farthest price though ordered ASC (String API version)",
                farthest,
                subjectPrices.stream(food.name, new OrderBy<SubjectPriceRepository.Field>(SubjectPriceRepository.Field.DAY, Order.ASC), OptLimit.createLimit(1))
                        .findFirst().get()
        );
        ...
        assertEquals(
                "Not highest price though ordered DESC",
                price,
                subjectPrices.stream(food, new OrderBy<SubjectPriceRepository.Field>(SubjectPriceRepository.Field.PRICE, Order.DESC), OptLimit.createLimit(1)).findFirst().get()
        );
        assertEquals(
                "Not highest price though ordered DESC (String API version)",
                price,
                subjectPrices.stream(food.name, new OrderBy<SubjectPriceRepository.Field>(SubjectPriceRepository.Field.PRICE, Order.DESC), OptLimit.createLimit(1))
                        .findFirst().get()
        );
    }
