...
public final class FundsMutationSubjectRepoTester {
    ...
    public void testFindByParent() throws Exception {
        ...
        subjectRepository.findByParent(food1.id.getAsLong()).forEach(subject -> assertTrue("Wrong byParent stream: " + subject.name, subject.equals(meat) || subject.equals(vegs)));
    }
