...
public final class PostponedCurrencyExchangeEventRepoTester {
    ...
    public void testStreamRememberedExchanges() throws Exception {
        ...
        postExRepo.streamRememberedExchanges(new UtcDay(OffsetDateTime.of(1999, 12, 31, 23, 59, 59, 0, ZoneOffset.UTC)), CurrencyUnit.EUR, CurrencyUnit.USD).forEach(postponedExchange ->
